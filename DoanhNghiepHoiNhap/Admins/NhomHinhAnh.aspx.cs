...
NhomHinhAnhService.NhomHinhAnh_Delete(str[0]);}catch{}}}}
grd_showNhomHinhAnh.CurrentPageIndex = 0;
Loadgrd_showNhomHinhAnh();}catch{}}
...
try
{
NhomHinhAnhService.NhomHinhAnh_Insert(  txtTenNhom.Text, fckHinhAnh.Value, txtThuTu.Text);
}
catch
{
WebMsgBox.Show("Lỗi :");
...
try
{
NhomHinhAnhService.NhomHinhAnh_Update(  ViewState["id"].ToString(), txtTenNhom.Text, fckHinhAnh.Value, txtThuTu.Text);
}
catch
{
WebMsgBox.Show("Lỗi :");
...
fckHinhAnh.Value = dt.Rows[0]["HinhAnh"].ToString();

<%@ Page Title="Quản trị DoanhNhanThanhDat" Language="C#" MasterPageFile="~/Admins/Administrator.Master" AutoEventWireup="true" CodeBehind="DoanhNhanThanhDat.aspx.cs" Inherits="DoanhNghiepHoiNhap.Admins.DoanhNhanThanhDat" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"  %>
<%@ Register Assembly="FredCK.FCKeditorV2" Namespace="FredCK.FCKeditorV2" TagPrefix="FCKeditorV2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<div class="title">Quản trị DoanhNhanThanhDat </div>
...
<asp:TextBox ID="txtSDoanhNhanThanhDat" runat="server" Width="150px"></asp:TextBox><asp:DropDownList ID="ddlSColumnDoanhNhanThanhDat" runat="server" Width="70px"></asp:DropDownList><asp:DropDownList ID="ddlSearchColumn" runat="server" Width="150px"></asp:DropDownList><asp:Button ID="btnSearchColumn" runat="server" Text="Tìm kiếm" CssClass="button" onclick="btnSearchColumn_Click" /><asp:Button ID="btnShowAllData" runat="server" Text="Hiện tất cả" CssClass="button" onclick="btnShowAllData_Click" /></td></tr></table>
</td>
</tr>
<tr>
<td>
			...
			<tr>
				<td height="6">
					<asp:DataGrid ID="grd_showDoanhNhanThanhDat" runat="server" AllowPaging="True" CssClass="tableview" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" Width="100%" OnPageIndexChanged="grd_showDoanhNhanThanhDat_PageIndexChanged" PageSize="10" OnItemCommand="grd_showDoanhNhanThanhDat_ItemCommand" OnItemDataBound="grd_showDoanhNhanThanhDat_ItemDataBound"><AlternatingItemStyle BackColor="White" />
						<Columns>
...
<td><FCKeditorV2:FCKeditor ID="fckAnh" runat="server" BasePath="~/"></FCKeditorV2:FCKeditor>

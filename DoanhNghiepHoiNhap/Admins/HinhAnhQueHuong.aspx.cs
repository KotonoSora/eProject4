...
HinhAnhQueHuongService.HinhAnhQueHuong_Delete(str[0]);}catch{}}}}
grd_showHinhAnhQueHuong.CurrentPageIndex = 0;
Loadgrd_showHinhAnhQueHuong();}catch{}}
...
try
{
HinhAnhQueHuongService.HinhAnhQueHuong_Insert(  txtTieuDe.Text, txtMota.Text, txtHinhAnh.Text, txtThuTu.Text, ddlUNhomHinhAnh.SelectedValue, DateTimeClass.ConvertDateTime(txtNgayTao.Text, "MM/dd/yyyy"), txtNguoiTao.Text);
}
catch
{
WebMsgBox.Show("Lỗi :");
...
try
{
HinhAnhQueHuongService.HinhAnhQueHuong_Update(  ViewState["Id"].ToString(), txtTieuDe.Text, txtMota.Text, txtHinhAnh.Text, txtThuTu.Text, ddlUNhomHinhAnh.SelectedValue, DateTimeClass.ConvertDateTime(txtNgayTao.Text, "MM/dd/yyyy"), txtNguoiTao.Text);
}
catch
{
WebMsgBox.Show("Lỗi :");
...
txtHinhAnh.Text = dt.Rows[0]["HinhAnh"].ToString();
txtThuTu.Text = dt.Rows[0]["ThuTu"].ToString();
ddlUNhomHinhAnh.SelectedValue = dt.Rows[0]["NhomHinhAnh"].ToString();
...
{
grd_showHinhAnhQueHuong.DataSource = HinhAnhQueHuongService.HinhAnhQueHuong_GetAllKey();
grd_showHinhAnhQueHuong.DataBind();

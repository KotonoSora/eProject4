...
DoanhNhanThanhDatService.DoanhNhanThanhDat_Delete(str[0]);}catch{}}}}
grd_showDoanhNhanThanhDat.CurrentPageIndex = 0;
Loadgrd_showDoanhNhanThanhDat();}catch{}}
...
try
{
DoanhNhanThanhDatService.DoanhNhanThanhDat_Insert(  fckTen.Value, fckAnh.Value, fckGioiThieu.Value, txtDiaChi.Text, txtDienThoai.Text, txtEmail.Text, txtThuTu.Text);
}
catch
{
WebMsgBox.Show("Lỗi :");
...
try
{
DoanhNhanThanhDatService.DoanhNhanThanhDat_Update(  ViewState["Id"].ToString(), fckTen.Value, fckAnh.Value, fckGioiThieu.Value, txtDiaChi.Text, txtDienThoai.Text, txtEmail.Text, txtThuTu.Text);
}
catch
{
WebMsgBox.Show("Lỗi :");
...
fckAnh.Value = dt.Rows[0]["Anh"].ToString();
...
{
grd_showDoanhNhanThanhDat.DataSource = DoanhNhanThanhDatService.DoanhNhanThanhDat_GetAllKey();
grd_showDoanhNhanThanhDat.DataBind();

    ...
    public partial class DoanhNghiepQueHuong : Page
    {
                ...
                for (int i = 0; i < grd_showDoanhNghiepQueHuong.Items.Count; i++)
                {
                    ...
                    if (item.ItemType == ListItemType.AlternatingItem | item.ItemType == ListItemType.Item)
                    {
                        if (((CheckBox)item.FindControl("ChkSelect")).Checked)
                        {
                            ...
                            {
                                DoanhNghiepQueHuongService.DoanhNghiepQueHuong_Delete(str[0]);
                            }
                            catch { }
                        }
                    }
        ...
        protected void LbtUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (Insert.Checked)
            {
                ...
                try
                {
                    DoanhNghiepQueHuongService.DoanhNghiepQueHuong_Insert(txtTen.Text, txtImgUrl.Text, fckGioiThieu.Value, txtGiamDoc.Text, txtDiaChi.Text, txtDienThoai.Text, txtEmail.Text, txtThuTu.Text);
                }
                catch
                {
                    WebMsgBox.Show("Lỗi :");
            ...
            else
            {
                ...
                try
                {
                    DoanhNghiepQueHuongService.DoanhNghiepQueHuong_Update(ViewState["Id"].ToString(), txtTen.Text, txtImgUrl.Text, fckGioiThieu.Value, txtGiamDoc.Text, txtDiaChi.Text, txtDienThoai.Text, txtEmail.Text, txtThuTu.Text);
                }
                catch
                {
                    WebMsgBox.Show("Lỗi :");
            ...
            switch (e.CommandName.Trim())
            {
                case "Edit":
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        txtImgUrl.Text = dt.Rows[0]["Logo"].ToString();
        ...
        {
            grd_showDoanhNghiepQueHuong.DataSource = DoanhNghiepQueHuongService.DoanhNghiepQueHuong_GetByTop("","","ThuTu");
            grd_showDoanhNghiepQueHuong.DataBind();

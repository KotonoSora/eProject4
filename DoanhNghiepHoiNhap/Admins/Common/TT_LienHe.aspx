<%@ Page Title="Xử lý góp ý khách hàng" Language="C#" MasterPageFile="~/Admins/Common/Common.Master"
    AutoEventWireup="true" CodeBehind="TT_LienHe.aspx.cs" Inherits="DoanhNghiepHoiNhap.Admins.TT_LienHe" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlLoai" runat="server" AutoPostBack="true" 
                                    CssClass="textbox" Height="30px" Width="300px" 
                                    onselectedindexchanged="ddlSNhomHangHoa_SelectedIndexChanged">                                   
                                </asp:DropDownList>
                            </td>
                        </tr> 
                    </table>
                ...
                <td height="6">
                    <asp:DataGrid ID="grd_showTT_LienHe" runat="server" AutoGenerateColumns="False" CssClass="tableview"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn>
                                <HeaderTemplate><%=Lang.Show("address")%></HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="grdLblDiaChi" runat="server" Text='<%#(Eval("DiaChi").ToString())%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn >
        ...
        <table id="Table2" style="border-collapse: collapse" cellpadding="0" width="100%"
            ...
            <tr>
             ...
             <tr>
                <td width="150" class="name_fild_row">
                    &nbsp;
                    <asp:Label ID="lblUDiaChi" Text="Địa chỉ" runat="server"><%=Lang.Show("address") %>:</asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtDiaChi" CssClass="textbox" runat="server" Width="300px"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    &nbsp;
                    <asp:LinkButton ID="lbtCancel" runat="server" CssClass="back" OnClick="LbtCancel_Click"></asp:LinkButton>
                </td>
            </tr>
        </table>
    </asp:Panel>

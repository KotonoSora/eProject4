<%@ Page Title="Quản trị TH_TheLoaiSach" Language="C#" MasterPageFile="~/Admins/Common/Common.Master" AutoEventWireup="true" CodeBehind="TH_TheLoaiSach.aspx.cs" Inherits="DoanhNghiepHoiNhap.Admins.TH_TheLoaiSach" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="title">Quản trị Thể Loại Truyện Tranh </div>
    <asp:Panel ID="pn_showTH_TheLoaiSach" runat="server" Width="100%">
        <table id="Table1" style="border-collapse: collapse; background-color: #D0DEF0;" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                <td height="6">
                    <asp:DataGrid ID="grd_showTH_TheLoaiSach" runat="server" AllowPaging="True" CssClass="tableview" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" Width="100%" OnPageIndexChanged="grd_showTH_TheLoaiSach_PageIndexChanged" PageSize="10" OnItemCommand="grd_showTH_TheLoaiSach_ItemCommand" OnItemDataBound="grd_showTH_TheLoaiSach_ItemDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Tên thể loại sách">
                                <ItemTemplate>
                                    <%#(Eval("TenTheLoaiSach").ToString())%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="Mô tả về thể loại">
                                <ItemTemplate>
    ...
    <asp:Panel ID="pn_updateTH_TheLoaiSach" runat="server" Visible="False" Width="100%">
        <table id="Table2" style="border-collapse: collapse" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                <td width="150" class="name_fild_row">&nbsp;Tên thể loại Sách
:
</td>
                <td>
                    <asp:TextBox CssClass="textbox" ID="txtTenTheLoaiSach" runat="server" Width="300px"></asp:TextBox>
                    <asp:Label ID="lblerrorTenTheLoaiSach" runat="server" Text="" ForeColor="Red"></asp:Label>

                </td>
            </tr>
            <tr>
                <td width="150" class="name_fild_row">&nbsp;Mô tả về thể loại sách
:
</td>
                <td>

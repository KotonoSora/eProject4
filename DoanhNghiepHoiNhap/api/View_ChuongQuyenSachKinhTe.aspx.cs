...
{
    public partial class View_ChuongQuyenSachKinhTe : System.Web.UI.Page
    {
        ...
        public void load_dulieu(string id_chuong, string id_qs)
        {
            ...
            if (dt_ != null && dt_.Rows.Count > 0)
            {
                ...
                string repac = dt_.Rows[0]["NoiDung"].ToString().Replace("height", "").Replace("width","");

                Literal1.Text = repac + "<br />";
            }
            else
            {
